...
bool mutate_weight_b2 = true;

static bool evaluateCondition(void)
{
   return (mutate_weight_b2);
}

static void evaluatePredicatemutate_weight_2(Morphism *morphism)
{
   ...
   if(var_3 - 1 >= -1000) mutate_weight_b2 = true;
   else mutate_weight_b2 = false;
}
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "mutate_weight_weight3", mutate_weight_host);
