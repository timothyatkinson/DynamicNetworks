...
bool mutate_weight_b1 = true;

static bool evaluateCondition(void)
{
   return (mutate_weight_b1);
}

static void evaluatePredicatemutate_weight_1(Morphism *morphism)
{
   ...
   if(var_3 + 2 <= 1000) mutate_weight_b1 = true;
   else mutate_weight_b1 = false;
}
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "mutate_weight_weight2", mutate_weight_host);
