...
bool matchrandom_d_graph_delete_loop(Morphism *morphism)
{
...
void applyrandom_d_graph_delete_loop(Morphism *morphism, bool record_changes)
{
...
bool fillpotrandom_d_graph_delete_loop(MorphismPot *pot, Morphism *morphism)
{
   if(1 > random_d_graph_host->number_of_nodes || 1 > random_d_graph_host->number_of_edges) return false;
...
static bool fillpot_e0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(counter = 0; counter < host_node->out_edges.size + 2; counter++)
   {
      ...
      if(match)
      {
         ...
         host_edge->matched = true;
      /* All items matched! */
            putMorphism(pot, morphism, "random_d_graph_delete_loop", random_d_graph_host);
